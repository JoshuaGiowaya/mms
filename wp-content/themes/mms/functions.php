...
/*
Shortcode for "expert_slider" expert page
*/
add_shortcode('expert_slider', 'expert_slider_shortcode_function');

 function expert_slider_shortcode_function() {
   ob_start();
   
   ?>
    <section class="hero__element expert__slider-box">
        <div id="bxslider" class="bxslider ">
  <div><img src="http://gutoplis.com/2018/dev/mms/wp-content/uploads/2018/02/expert-banner.jpg" >

    <div class="container">
<div class="expert__slider--block">
    <h3 class="expert__slider--block--heading">Case Study: South Education Center</h3>
        <p class="expert__slider--block--content">Summary Founded in 1967, Intermediate District 287 was born of a common goal to provide students <span class="content-block">with new options in vocational education.Over the course of 40 years,the district has added a reputable</span> list of academic specialty areas,and has grown into 13 west Minneapolis area district</p></div>
</div>
</div>
  <div>
      <img src="http://gutoplis.com/2018/dev/mms/wp-content/uploads/2018/02/expert-banner.jpg">
  <div class="container">
<div class="expert__slider--block">
    <h3 class="expert__slider--block--heading">Case Study: South Education Center</h3>
        <p class="expert__slider--block--content">Summary Founded in 1967, Intermediate District 287 was born of a common goal to provide students <span class="content-block">with new options in vocational education.Over the course of 40 years,the district has added a reputable</span> list of academic specialty areas,and has grown into 13 west Minneapolis area district</p></div>
